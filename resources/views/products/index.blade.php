...
<tr>
    ...
    <tr>
            ...
            <td>
              ...
              <a href="javascript:void(0)" v-on:click="productFix({{ $row->product_id }})" style="cursor: pointer" data-toggle="modal" data-target="#exampleModalCenter"  class="text-dark" >{{ $row->name }}</a></div>
                  <div class=" col-md-6">@php $tag = explode(",", $row->tags); foreach($tag as $t){echo'<span class="badge badge-secondary p-2 m-1">'. $t.'</span>';} @endphp</div>
              </div>
